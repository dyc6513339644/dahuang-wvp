...
export const dynamicRoutes = [
...

  {
    ...
    component: Layout,
    hidden: true,
    permissions: ['wvp:device:channels'],
    children: [
      {
...

  {
    ...
    component: Layout,
    hidden: true,
    permissions: ['wvp:record:channelList'],
    children: [
      {
        noCache: true,
        path: 'index/:planId(\\d+)',
...

  {
    ...
    component: Layout,
    hidden: true,
    permissions: ['wvp:platform:channelList'],
    children: [
      {
        noCache: true,
  ...
  {
    path: '/gbmanger/node/addMediaServer',
    component: Layout,
    hidden: true,
    permissions: ['wvp:server:add'],
    children: [
      {
        noCache: true,
        path: 'index',
  ...
  {
    path: '/gbmanger/node/updateMediaServer',
    component: Layout,
    hidden: true,
    permissions: ['wvp:server:edit'],
    children: [
      {
        noCache: true,
        path: 'index',

...
public class StreamPushController extends BaseController {
     ...
     * @return
     */
    @PreAuthorize("@ss.hasPermi('wvp:push:list')")
     ...
     * @param id 应用名
     */
    @PreAuthorize("@ss.hasPermi('wvp:push:remove')")
     ...
     * @return
     */
    @PreAuthorize("@ss.hasPermi('wvp:push:add')")
     ...
     * @param stream
     */
    @PreAuthorize("@ss.hasPermi('wvp:push:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('wvp:push:play')")
